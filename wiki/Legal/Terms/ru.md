...
# Условия использования osu!

Последнее обновление оригинальной (английской) версии: 25 мая 2018. [Посмотреть историю](https://github.com/ppy/osu-wiki/commits/master/wiki/Legal/Terms/en.md)

**ppy Pty Ltd** предоставляет Вам сервис, which is conditioned on your acceptance, without any modification whatsoever to the following terms, conditions, and notices.

Посещая и/или используя сервисы, предоставляемые сайтом ([https://osu.ppy.sh](https://osu.ppy.sh/home)), игровым клиентом osu! (который может быть найден на страницу [https://osu.ppy.sh/home/download](https://osu.ppy.sh/home/download)) or any affiliated services (henceforth referenced as "**osu!**"), you are acknowledging your full compliance to the terms and conditions listed here.
...
## ИСОЛЬЗОВАНИЕ ВАМИ КОНТЕНТА НА САЙТЕ
